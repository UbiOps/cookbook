...
def ubiops_request(event, context):
    """
    Pipeline batch request triggered from a message on a Cloud Pub/Sub topic.
    ...
    api.batch_pipeline_requests_create(project_name='test-project', pipeline_name='test-pipeline', data=pubsub_message)
